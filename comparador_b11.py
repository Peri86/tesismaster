...
def escollir(arllegit,nllegit):
    ...
    for i in range(len(sel)):
        if sel[i] == "infomap":
            ...
            #########Parametres##########
            print "Betweenness :"
            print arllegit.betweenness(directed=False, cutoff=16)
            print "Betweenness Centrality:"
            print betweenness_centralization(arllegit)
            print "Average path length :"
            print arllegit.average_path_length()
            print "Assortativity meu:" # es el mateix que el degree?
            print assortativitymeu(arllegit)  
            print "Assortativity degree:"
            print arllegit.assortativity_degree()
            print "Diameter:"
            print arllegit.diameter()
            print "Pagerank:"
            print arllegit.pagerank()
            #print "Assortativity com:" # En el graf de comunitats no troba el degree
            #print assortativitymeu(cl)
            ###########################
