...
# Amb linux les xarxes per llegir surten esparades del format
...
# Adjuntar conversor amb comparador
...
# Afegir temps que tarden els algorismes per la comparativa
    ...
    while(sortida != True):
        if comunitats == False:
            ...
            if op == '1':
                ...
                comu.benchmark(arllegitnet,com)
                #comu.comparador(com)
            elif op == '4':
                guardarcom(com)
            elif op == '5':
