...
def escollir(arllegit,nllegit):
    ...
    #print '\n'
    #El jolleycraig es una implementacio del leading eigenvector fixant dues comunitats. L'original es aquest 
    #MEJ Newman: Finding community structure in networks using the eigenvectors of matrices, Phys Rev E 74:036104, 2006
    # Link explicacio : http://lists.gnu.org/archive/html/igraph-help/2010-09/msg00069.html
    ...
    for i in range(len(sel)):
        ...
        #elif sel[i] == "jolleycraig": #Dona una llista necesito particio
        #    print "funcio de newman - jolleycraig"
        #    particiocj = cj.detect_communities(und_arllegit)
        #    print particiocj[1]
        #    print particiocj[1].values()
        #    a = particiocj[1]
        #    #o = dict()
        #    #print 'a : '
        #    #print a
...
def netescollir(arllegit,nllegit):
    ...
    #print "\tModularity and community structure in networks.\n\t M. E. J. Newman. 2006.\n"
    #print '\n'
    #Explicat en la part de graphml, es el mateix que leading eigenvector amb 2 grups
